...
3) Edit `style.md` to incorporate the new info.
- Keep `style.md` < 100 lines; focus on highest-priority rules and index entries.
- Don't lose information: Consolidate into broader rules and/or move detail into `.style/<topic>.md`. Add one or more triggers to style.md telling when to look in the new file.
