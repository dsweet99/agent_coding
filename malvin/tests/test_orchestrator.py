...
def test_orchestrator_emits_progress_for_happy_path(tmp_path: Path) -> None:
...
def test_orchestrator_emits_progress_for_retry_cycle(tmp_path: Path) -> None:
    progress_messages: list[str] = []
    orchestrator = _build_orchestrator(
        tmp_path,
        review_1_outputs=["Needs fixes", "LGTM"],
